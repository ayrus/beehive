...
func init() {
    ...
    *insertURL = fmt.Sprintf("%v", u)
    testLog = log.New(os.Stderr, "Testing LPM-HTTP: ", 0)
}
...
func TestLPMGenericPut(t *testing.T) {
    testLog.Println("TestGenericPut")
...
func TestLPMEmptyDelete(t *testing.T) {
    testLog.Println("TestEmptyDelete")
...
func TestLPMGenericDelete(t *testing.T) {
    testLog.Println("TestGenericDelete")
...
func TestLPMGenericGet(t *testing.T) {
    testLog.Println("TestGenericGet")
...
func TestLPMGetHighPriority(t *testing.T) {
    testLog.Println("TestGetHighPriority")
    ...
    routes := [4]lpm.Route{r1, r2, r3, r4}
...
func TestLPMGetPrefixMatchLong(t *testing.T) {
    testLog.Println("TestGetPrefixMatchLong")
...
func TestLPMGetAfterDelete(t *testing.T){
    testLog.Println("TestGetAfterDelete")
